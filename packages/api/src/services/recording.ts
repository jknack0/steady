...
import { LIVEKIT_API_KEY, LIVEKIT_API_SECRET, LIVEKIT_URL, S3_BUCKET } from "../lib/env";
 ...
 */
export async function onSessionEnd(sessionId: string, audioPath: string): Promise<void> {
